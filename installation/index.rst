...
- Installateur _gtf_application_web, exécutable et scripts d'installation, de mise à jour et de suppression de GTF.
- Moteur_gf.zip, archive d'installation du module GTF
- Pycron-0.5.9.0.exe, installateur de Pycron
- Procedure_installation_gtf_windows.pdf, la présente documentation.
